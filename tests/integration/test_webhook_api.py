...
from tests.conftest import create_test_user, create_test_admin


class TestWebhookReceiver:
    """Test webhook receiver endpoints."""
    
    def test_receive_kyc_webhook_success(
        self,
        client: TestClient,
        db: Session
    ):
        ...
        signature = generate_webhook_signature(
            payload_str, provider, timestamp
        )
        ...
        response = client.post(
            f"/api/v1/webhooks/kyc/{provider.value}",
            data=payload_str,
            headers=headers
        )
        ...
        webhook = db.query(WebhookEvent).filter(
            WebhookEvent.id == data["webhook_id"]
        ).first()
    ...
    def test_receive_aml_webhook_success(
        self,
        client: TestClient,
        db: Session
    ):
        ...
        # Send webhook
        response = client.post(
            f"/api/v1/webhooks/aml/{provider.value}",
            data=payload_str,
            headers=headers
        )
    ...
    def test_receive_webhook_unsupported_provider(
        self,
        client: TestClient
    ):
    ...
    def test_receive_duplicate_webhook(
        self,
        client: TestClient,
        db: Session
    ):
...
class TestWebhookManagement:
    ...
    def test_list_webhook_events_admin(
        self,
        client: TestClient,
        db: Session
    ):
    ...
    def test_list_webhook_events_user_restricted(
        self,
        client: TestClient,
        db: Session
    ):
    ...
    def test_get_webhook_event_details(
        self,
        client: TestClient,
        db: Session
    ):
    ...
    def test_get_webhook_statistics(
        self,
        client: TestClient,
        db: Session
    ):
