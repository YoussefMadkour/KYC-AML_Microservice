...
class TestKYCRepository:
    ...
    def test_get_checks_by_status(self, kyc_repository, mock_db):
        ...
        result = kyc_repository.get_checks_by_status(KYCStatus.APPROVED, skip=10, limit=20)
...
class TestDocumentRepository:
    ...
    def test_get_by_type_and_check(self, document_repository, mock_db, sample_document):
        ...
        result = document_repository.get_by_type_and_check(kyc_check_id, DocumentType.PASSPORT)
    ...
    def test_update_verification_status_success(self, document_repository, mock_db, sample_document):
