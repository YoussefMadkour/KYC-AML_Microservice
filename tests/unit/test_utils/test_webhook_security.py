...
class TestWebhookSignatureVerifier:
    ...
    def test_generate_signature_with_custom_secret(self):
        ...
        expected_signature = hmac.new(
            custom_secret.encode("utf-8"), self.test_payload_bytes, hashlib.sha256
        ).hexdigest()
    ...
    def test_extract_signature_not_found(self):
        ...
        headers = {"Content-Type": "application/json", "User-Agent": "WebhookBot/1.0"}
    ...
    def test_extract_timestamp_invalid_format(self):
        ...
        headers = {"X-Webhook-Timestamp": "not_a_timestamp"}
...
class TestConvenienceFunctions:
    ...
    def test_verify_webhook_signature(self):
        ...
        is_valid = verify_webhook_signature(self.test_payload, signature, self.provider)
