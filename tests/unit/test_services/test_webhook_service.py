...
class TestWebhookService:
    ...
    async def test_receive_webhook_duplicate(self, webhook_service):
        ...
        webhook_service.webhook_repo.get_by_provider_event_id.return_value = existing_webhook
    ...
    async def test_get_webhook_events_by_kyc_check(self, webhook_service):
        ...
        webhook_service.webhook_repo.get_webhooks_by_kyc_check.return_value = mock_webhooks
    ...
    async def test_cleanup_old_webhooks(self, webhook_service):
        ...
        result = await webhook_service.cleanup_old_webhooks(days_old=90, keep_failed=True)
