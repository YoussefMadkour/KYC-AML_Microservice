        ...
        try:
            ...
            if validate_timestamp:
                ...
                if timestamp is not None:
                    ...
                    verification_details["timestamp_valid"] = True  # No timestamp required
            else:
                verification_details["timestamp_valid"] = True  # Timestamp validation disabled
...
def generate_webhook_signature(
    ...
    return webhook_signature_verifier.generate_signature(payload, provider, timestamp, secret)
...
def verify_webhook_signature(
    ...
    return webhook_signature_verifier.verify_signature(payload, signature, provider, timestamp, secret)
