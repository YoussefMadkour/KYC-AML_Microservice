...
class KYCTask(BaseTask):
    ...
    def apply_async(self, args=None, kwargs=None, **options):
        ...
        if kwargs and "correlation_id" not in kwargs:
            kwargs["correlation_id"] = self.request.id if hasattr(self, "request") else None
...
class WebhookTask(BaseTask):
    ...
    def apply_async(self, args=None, kwargs=None, **options):
        ...
        if kwargs and "idempotency_key" not in kwargs:
            kwargs["idempotency_key"] = f"webhook_{self.request.id}" if hasattr(self, "request") else None
